...
pub(super) struct LogCounters {
    ...
    pub(super) candidate_remove_ns: u64,
    pub(super) candidate_neighbor_ns: u64,
    pub(super) candidate_insert_ns: u64,
    pub(super) candidate_newly_added_ns: u64,
    pub(super) candidate_history_ns: u64,
    pub(super) hash_update_ns: u64,
    pub(super) move_undo_ns: u64,
    pub(super) hash_ns: u64,
    pub(super) children_lock_ns: u64,
...
impl LogCounters {
    pub(super) fn from_tree(tree: &SharedTree) -> Self {
        Self {
            ...
            candidate_remove_ns: tree.get_candidate_remove_time_ns(),
            candidate_neighbor_ns: tree.get_candidate_neighbor_time_ns(),
            candidate_insert_ns: tree.get_candidate_insert_time_ns(),
            candidate_newly_added_ns: tree.get_candidate_newly_added_time_ns(),
            candidate_history_ns: tree.get_candidate_history_time_ns(),
            hash_update_ns: tree.get_hash_update_time_ns(),
            move_undo_ns: tree.get_move_undo_time_ns(),
            hash_ns: tree.get_hash_time_ns(),
            children_lock_ns: tree.get_children_lock_time_ns(),
    ...
    pub(super) const fn timing_input(&self) -> TimingInput {
        TimingInput {
            ...
            candidate_remove_ns: self.candidate_remove_ns,
            candidate_neighbor_ns: self.candidate_neighbor_ns,
            candidate_insert_ns: self.candidate_insert_ns,
            candidate_newly_added_ns: self.candidate_newly_added_ns,
            candidate_history_ns: self.candidate_history_ns,
            hash_update_ns: self.hash_update_ns,
            move_undo_ns: self.move_undo_ns,
            hash_ns: self.hash_ns,
            children_lock_ns: self.children_lock_ns,
